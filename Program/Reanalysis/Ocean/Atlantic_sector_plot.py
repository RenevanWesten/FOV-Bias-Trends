...
files	= glob.glob(directory+'Data/Atlantic_sector/Reanalysis_data_year_*.nc')
files.sort()
...
ax.set_title('a) Salinity, Reanalysis (1994 - 2020)')
...
ax.set_title('Temperature, Reanalysis (1994 - 2020)')
...
ax.set_title('d) Zonal velocity and potential density, Reanalysis (1994 - 2020)')
