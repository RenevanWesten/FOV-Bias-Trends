...
def ReadinData(filename):
	...
	FOV_AAIW	= fh.variables['F_OV_AAIW'][:]	#Freshwater (Sv)
	FOV_NADW	= fh.variables['F_OV_NADW'][:]	#Freshwater (Sv)
	FOV_AABW	= fh.variables['F_OV_AABW'][:]	#Freshwater (Sv)

	fh.close()

	return time, FOV, FOV_ASW, FOV_AAIW, FOV_NADW, FOV_AABW
...
transport_salt_AAIW_all	= ma.masked_all((len(models), 2))
transport_salt_NADW_all	= ma.masked_all((len(models), 2))
transport_salt_AABW_all	= ma.masked_all((len(models), 2))
...
transport_salt_AAIW_time	= ma.masked_all((107, len(models)))
...
for model_i in range(len(models)):
	...
	time, FOV, FOV_ASW, FOV_AAIW, FOV_NADW, FOV_AABW	= ReadinData(filename_FOV)
	...
	transport_salt_AAIW_time[:len(time), model_i]	= FOV_AAIW
	...
	transport_salt_AAIW_all[model_i, 0]	= np.mean(FOV_AAIW[time_present_start:time_present_end])
	transport_salt_NADW_all[model_i, 0]	= np.mean(FOV_NADW[time_present_start:time_present_end])
	transport_salt_AABW_all[model_i, 0]	= np.mean(FOV_AABW[time_present_start:time_present_end])
	...
	FOV_AAIW_trend, b	= np.polyfit(time[time_future_start:time_future_end], FOV_AAIW[time_future_start:time_future_end], 1)
	FOV_NADW_trend, b	= np.polyfit(time[time_future_start:time_future_end], FOV_NADW[time_future_start:time_future_end], 1)
	FOV_AABW_trend, b	= np.polyfit(time[time_future_start:time_future_end], FOV_AABW[time_future_start:time_future_end], 1)
	...
	transport_salt_AAIW_all[model_i, 1]	= FOV_AAIW_trend * 100.0
	transport_salt_NADW_all[model_i, 1]	= FOV_NADW_trend * 100.0
	transport_salt_AABW_all[model_i, 1]	= FOV_AABW_trend * 100.0
...
time_HR, FOV_HR, FOV_ASW_HR, FOV_AAIW_HR, FOV_NADW_HR, FOV_AABW_HR = ReadinData(directory_iHESP+'FOV_index_section_34S_RCP_HR.nc')
time_HR, AMOC_HR						 = ReadinDataAMOC(directory_iHESP+'AMOC_transport_depth_'+str(depth_min)+'-'+str(depth_max)+'m_RCP_HR.nc')
time_LR, FOV_LR, FOV_ASW_LR, FOV_AAIW_LR, FOV_NADW_LR, FOV_AABW_LR = ReadinData(directory_iHESP+'FOV_index_section_34S_RCP_LR.nc')
...
FOV_AAIW_mean_HR		= np.mean(FOV_AAIW_HR[time_present_start:time_present_end])
FOV_NADW_mean_HR	= np.mean(FOV_NADW_HR[time_present_start:time_present_end])
FOV_AABW_mean_HR		= np.mean(FOV_AABW_HR[time_present_start:time_present_end])
...
FOV_AAIW_mean_LR		= np.mean(FOV_AAIW_LR[time_present_start:time_present_end])
FOV_NADW_mean_LR	= np.mean(FOV_NADW_LR[time_present_start:time_present_end])
FOV_AABW_mean_LR		= np.mean(FOV_AABW_LR[time_present_start:time_present_end])
...
FOV_AAIW_trend_HR, b	= np.polyfit(time_HR[time_future_start:time_future_end], FOV_AAIW_HR[time_future_start:time_future_end], 1) * 100.0
...
FOV_AABW_trend_HR, b	= np.polyfit(time_HR[time_future_start:time_future_end], FOV_AABW_HR[time_future_start:time_future_end], 1) * 100.0
...
FOV_AAIW_trend_LR, b	= np.polyfit(time_LR[time_future_start:time_future_end], FOV_AAIW_LR[time_future_start:time_future_end], 1) * 100.0
...
FOV_AABW_trend_LR, b	= np.polyfit(time_LR[time_future_start:time_future_end], FOV_AABW_LR[time_future_start:time_future_end], 1) * 100.0
...
time_rean, FOV_rean, FOV_ASW_rean, FOV_AAIW_rean, FOV_NADW_rean, FOV_AABW_rean = ReadinData(directory_reanalysis+'FOV_index_section_34S.nc')
...
FOV_AAIW_mean_rean	= np.mean(FOV_AAIW_rean)
FOV_NADW_mean_rean	= np.mean(FOV_NADW_rean)
FOV_AABW_mean_rean	= np.mean(FOV_AABW_rean)
...
ax.scatter(np.mean(transport_salt_all[:, 0]), np.mean(AMOC_all[:, 0]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax.scatter(FOV_mean_rean, AMOC_mean_rean, s = 70, color = 'c', marker = 'H', label = 'Reanalysis', zorder = 10)
...
ax.scatter(np.mean(transport_salt_all[:, 0]), np.mean(transport_salt_ASW_all[:, 0]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax.scatter(FOV_mean_rean, FOV_ASW_mean_rean, s = 70, color = 'c', marker = 'H', label = 'Reanalysis', zorder = 10)
...
#Determine the CMIP6 model regression
a, b	= np.polyfit(transport_salt_all[:, 0], transport_salt_AAIW_all[:, 0], 1)
x_plot	= np.array([transport_salt_all[:, 0].min(), transport_salt_all[:, 0].max()])
y_plot	= a * x_plot + b
r_2	= 1.0 - np.sum((transport_salt_AAIW_all[:, 0] - (a * transport_salt_all[:, 0] + b))**2.0) / np.sum((transport_salt_AAIW_all[:, 0] - np.mean(transport_salt_AAIW_all[:, 0]))**2.0)

print('CMIP6 model regression (FOV vs. AAIW):', a)
...
ax.plot(x_plot, y_plot, '--k', zorder = 0)
ax.scatter(transport_salt_all[models_1, 0], transport_salt_AAIW_all[models_1, 0], marker = 'D', color = 'k', s = 50, alpha = 0.5, zorder = 1)
ax.scatter(transport_salt_all[models_2, 0], transport_salt_AAIW_all[models_2, 0], marker = 'o', color = 'k', s = 50, alpha = 0.5, zorder = 1)
ax.scatter(transport_salt_all[models_3, 0], transport_salt_AAIW_all[models_3, 0], marker = 'x', color = 'k', s = 50, alpha = 0.5, zorder = 1)
ax.set_xlim(-0.51, 0.51)
ax.set_ylim(-0.51, 0.51)
ax.set_xlabel('Freshwater transport (Sv)')
ax.set_ylabel('AAIW freshwater transport (Sv)')
ax.grid()

ax.scatter(np.mean(transport_salt_all[:, 0]), np.mean(transport_salt_AAIW_all[:, 0]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
ax.scatter(FOV_mean_HR, FOV_AAIW_mean_HR, s = 70, color = 'r', label = 'HR-CESM', zorder = 10)
ax.scatter(FOV_mean_LR, FOV_AAIW_mean_LR, s = 70, color = 'b', label = 'LR-CESM', zorder = 10)
ax.scatter(FOV_mean_rean, FOV_AAIW_mean_rean, s = 70, color = 'c', marker = 'H', label = 'Reanalysis', zorder = 10)

ax.errorbar(np.mean(transport_salt_all[:, 0]), np.mean(transport_salt_AAIW_all[:, 0]), xerr = np.std(transport_salt_all[:, 0]), yerr = np.std(transport_salt_AAIW_all[:, 0]), color = 'k') 
ax.errorbar(FOV_mean_rean, FOV_AAIW_mean_rean, xerr = np.std(FOV_rean), yerr = np.std(FOV_AAIW_rean), color = 'c') 

ax.text(0.97, 0.95, '$R^2$ = '+str(round(r_2, 2)), verticalalignment='center', horizontalalignment='right', color = 'k', fontsize = 12, transform = ax.transAxes)

ax.legend(loc='upper left', fancybox=True, shadow=False, scatterpoints=1, ncol = 1, framealpha = 1.0)
ax.set_title('e) $F_{\mathrm{ovS}}$ and AAIW, 1994 - 2020')

#-----------------------------------------------------------------------------------------

ax2 	= fig.add_axes([0.53, 0.17, 0.34, 0.2])

ax2.plot(time, np.mean(transport_salt_AAIW_time, axis = 1), '-k')
ax2.fill_between(time, y1 = np.percentile(transport_salt_AAIW_time, 2.5, axis = 1), y2 = np.percentile(transport_salt_AAIW_time, 97.5, axis = 1), alpha=0.25, edgecolor='black', facecolor='black')
ax2.fill_between(time, y1 = np.percentile(transport_salt_AAIW_time, 25, axis = 1), y2 = np.percentile(transport_salt_AAIW_time, 75, axis = 1), alpha=0.25, edgecolor='black', facecolor='black')
ax2.set_xlim(1994, 2100)
ax2.set_ylim(-0.2, 0.2)
ax2.set_yticks([-0.2, 0, 0.2])
ax2.grid()
ax2.set_title('AAIW (Sv) in CMIP6', fontsize = 10)
...
ax.scatter(np.mean(transport_salt_all[:, 0]), np.mean(transport_salt_NADW_all[:, 0]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax.scatter(FOV_mean_rean, FOV_NADW_mean_rean, s = 70, color = 'c', marker = 'H', label = 'Reanalysis', zorder = 10)
...
ax.scatter(np.mean(transport_salt_all[:, 1]), np.mean(AMOC_all[:, 1]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax.scatter(np.mean(transport_salt_all[:, 1]), np.mean(transport_salt_ASW_all[:, 1]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
#Determine the CMIP6 model regression
a, b	= np.polyfit(transport_salt_all[:, 1], transport_salt_AAIW_all[:, 1], 1)
x_plot	= np.array([transport_salt_all[:, 1].min(), transport_salt_all[:, 1].max()])
y_plot	= a * x_plot + b
r_2	= 1.0 - np.sum((transport_salt_AAIW_all[:, 1] - (a * transport_salt_all[:, 1] + b))**2.0) / np.sum((transport_salt_AAIW_all[:, 1] - np.mean(transport_salt_AAIW_all[:, 1]))**2.0)

print('CMIP6 model regression (FOV vs. AAIW trends):', a)
...
ax.plot(x_plot, y_plot, '--k', zorder = 0)
ax.scatter(transport_salt_all[models_1, 1], transport_salt_AAIW_all[models_1, 1], marker = 'D', color = 'k', s = 50, alpha = 0.5, zorder = 1)
ax.scatter(transport_salt_all[models_2, 1], transport_salt_AAIW_all[models_2, 1], marker = 'o', color = 'k', s = 50, alpha = 0.5, zorder = 1)
ax.scatter(transport_salt_all[models_3, 1], transport_salt_AAIW_all[models_3, 1], marker = 'x', color = 'k', s = 50, alpha = 0.5, zorder = 1)

ax.set_xlim(-0.51, 0.51)
ax.set_ylim(-0.3, 0.3)
ax.set_xlabel('Freshwater transport trend (Sv per century)')
ax.set_ylabel('AAIW freshwater transport trend (Sv per century)')
ax.grid()

ax.scatter(np.mean(transport_salt_all[:, 1]), np.mean(transport_salt_AAIW_all[:, 1]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
ax.scatter(FOV_trend_HR, FOV_AAIW_trend_HR, s = 70, color = 'r', label = 'HR-CESM', zorder = 10)
ax.scatter(FOV_trend_LR, FOV_AAIW_trend_LR, s = 70, color = 'b', label = 'LR-CESM', zorder = 10)

ax.errorbar(np.mean(transport_salt_all[:, 1]), np.mean(transport_salt_AAIW_all[:, 1]), xerr = np.std(transport_salt_all[:, 1]), yerr = np.std(transport_salt_AAIW_all[:, 1]), color = 'k') 

ax.text(0.97, 0.95, '$R^2$ = '+str(round(r_2, 2)), verticalalignment='center', horizontalalignment='right', color = 'k', fontsize = 12, transform = ax.transAxes)

ax.legend(loc='upper left', fancybox=True, shadow=False, scatterpoints=1, ncol = 1, framealpha = 1.0)
ax.set_title('f) $F_{\mathrm{ovS}}$ and AAIW trends, 2000 - 2100')
...
ax.scatter(np.mean(transport_salt_all[:, 1]), np.mean(transport_salt_NADW_all[:, 1]), s = 70, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax2.scatter(np.mean(salt_RMS_all), np.mean(vel_RMS_all), s = 30, color = 'k', marker = 'x', label = 'CMIP6 mean', zorder = 10)
...
ax2.scatter(0, 0, s = 30, color = 'c', marker = 'H', label = 'Reanalysis', zorder = 10)
