...
fh 		= netcdf.Dataset(directory+'Data/PI_control_LR/SALT_SO_'+str(depth_min)+'_'+str(depth_max)+'m/iHESP_data_year_0021.nc', 'r')

salt_year_21	= fh.variables['SALT'][:]

fh.close()

fh 		= netcdf.Dataset(directory+'Data/PI_control_LR/SALT_SO_'+str(depth_min)+'_'+str(depth_max)+'m/iHESP_data_year_0100.nc', 'r')
...
ax.plot([1610, 1791], [35.1, 34.46], ':k', linewidth = 0.5, zorder = 0)
ax.plot([1610, 1791], [34.7, 34.12], ':k', linewidth = 0.5, zorder = 0)
ax.plot([1600, 1661], [35.1, 34.46], ':k', linewidth = 0.5, zorder = 0)
ax.plot([1600, 1661], [34.7, 34.12], ':k', linewidth = 0.5, zorder = 0)
