...
time_control, FOV_34S_control	  = ReadinData(directory+'Ocean/FOV_index_section_34S_PI_control_HR.nc')
time_control, FOV_60N_control	  = ReadinData(directory+'Ocean/FOV_index_section_60N_PI_control_HR.nc')
time_rcp, FOV_34S_rcp		      = ReadinData(directory+'Ocean/FOV_index_section_34S_RCP_HR.nc')
time_rcp, FOV_60N_rcp		      = ReadinData(directory+'Ocean/FOV_index_section_60N_RCP_HR.nc')
time_control			          += 1599
#-----------------------------------------------------------------------------------------
...
print('FOV RCP HR-CESM (60N): ', np.mean(FOV_60N_rcp[144:171]))
...
ax.set_title('a) Freshwater convergence, HR-CESM, PI control')
#-----------------------------------------------------------------------------------------
...
ax.set_title('c) Freshwater convergence, HR-CESM, Hist/RCP8.5')
