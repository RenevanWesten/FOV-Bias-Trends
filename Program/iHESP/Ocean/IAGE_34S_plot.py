...
def ReadinData(filename):
	...
	age_AAIW		= fh.variables['IAGE_AAIW'][:]	#Ideal age (yr)
	age_NADW	= fh.variables['IAGE_NADW'][:]	#Ideal age (yr)
	age_AABW		= fh.variables['IAGE_AABW'][:]	#Ideal age (yr)

	fh.close()

	return time, age, age_ASW, age_AAIW, age_NADW, age_AABW
...
time_control_HR, age_control_HR, age_ASW_control_HR, age_AAIW_control_HR, age_NADW_control_HR, age_AABW_control_HR	= ReadinData(directory+'Ocean/IAGE_'+section_name+'_PI_control_HR.nc')
time_control_LR, age_control_LR, age_ASW_control_LR, age_AAIW_control_LR, age_NADW_control_LR, age_AABW_control_LR	= ReadinData(directory+'Ocean/IAGE_'+section_name+'_PI_control_LR.nc')
#-----------------------------------------------------------------------------------------
...
graph_control		= plot(time_control_HR, age_AAIW_control_HR, '-r', linewidth = 2.0, label = 'HR-CESM PI control')
graph_control_LR	= plot(time_control_LR, age_AAIW_control_LR, '-b', linewidth = 2.0, label = 'LR-CESM PI control')
plot([1, 500], [1, 500], '--k')
...
ax.set_title('f) Antarctic Intermediate Water (AAIW)')
...
graph_control		= plot(time_control_HR, age_AABW_control_HR, '-r', linewidth = 2.0, label = 'HR-CESM PI control')
graph_control_LR	= plot(time_control_LR, age_AABW_control_LR, '-b', linewidth = 2.0, label = 'LR-CESM PI control')
plot([1, 500], [1, 500], '--k')
...
ax.set_title('h) Antarctic Bottom Water (AABW)')
