...
ax.plot([1600, 1600, 1610, 1610, 1600], [-0.05, 0.25, 0.25, -0.05, -0.05], '--k', linewidth = 1.0)
ax.plot([1610, 1765], [0.25, -0.051], ':k', linewidth = 0.5, zorder = 0)
ax.plot([1610, 1765], [-0.05, -0.15], ':k', linewidth = 0.5, zorder = 0)
