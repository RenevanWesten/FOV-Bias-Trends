...
time_control, transport_control, FOV_control, FOV_ASW_control, FOV_AAIW_control, FOV_NADW_control, FOV_AABW_control = ReadinData(directory+'Ocean/FOV_index_'+section_name+'_PI_control_LR.nc')
time_rcp, transport_rcp, FOV_rcp, FOV_ASW_rcp, FOV_AAIW_rcp, FOV_NADW_rcp, FOV_AABW_rcp	= ReadinData(directory+'Ocean/FOV_index_'+section_name+'_RCP_LR.nc')
time_control	 += 1599

#-----------------------------------------------------------------------------------------

time_rean, transport_rean, FOV_rean, FOV_ASW_rean, FOV_AAIW_rean, FOV_NADW_rean, FOV_AABW_rean = ReadinDataReanalysis(directory_reanalysis+'Ocean/FOV_index_'+section_name+'.nc')
...
ax.set_title('d) Antarctic Intermediate Water (AAIW), LR-CESM')
...
ax.set_title('h) Antarctic Bottom Water (AABW), LR-CESM')
