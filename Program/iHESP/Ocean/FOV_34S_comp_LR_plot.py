...
time_control, transport_control, FOV_control, FOV_ASW_control, FOV_AIW_control, FOV_NADW_control, FOV_ABW_control, salt_ASW_control, salt_AIW_control, salt_NADW_control, salt_ABW_control, vel_ASW_control, vel_AIW_control, vel_NADW_control, vel_ABW_control = ReadinData(directory+'Ocean/FOV_index_'+section_name+'_PI_control_LR.nc')
time_rcp, transport_rcp, FOV_rcp, FOV_ASW_rcp, FOV_AIW_rcp, FOV_NADW_rcp, FOV_ABW_rcp, salt_ASW_rcp, salt_AIW_rcp, salt_NADW_rcp, salt_ABW_rcp, vel_ASW_rcp, vel_AIW_rcp, vel_NADW_rcp, vel_ABW_rcp		= ReadinData(directory+'Ocean/FOV_index_'+section_name+'_RCP_LR.nc')
time_control	 += 1599
...
ax.set_title('b) Atlantic Surface Water (ASW), LR-CESM')
...
ax.set_title('d) Antarctic Intermediate Water (AIW), LR-CESM')
...
ax.set_title('f) North Atlantic Deep Water (NADW), LR-CESM')
...
ax.set_title('h) Antarctic Bottom Water (ABW), LR-CESM')
