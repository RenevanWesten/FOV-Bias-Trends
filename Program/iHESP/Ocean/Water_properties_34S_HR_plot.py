...
files = glob.glob(directory+'Data/RCP_HR/FOV_section_34S/iHESP_data_year_*.nc')
files.sort()
...
ax.text(1.9, 850, 'AAIW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)
ax.text(1.9, 1350, 'NADW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)
ax.text(1.9, 1900, 'AABW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)

ax.set_title('b) Meridional velocity, HR-CESM (1994 - 2020)')
...
ax.set_title('e) Salinity, HR-CESM (1994 - 2020)')
...
ax.text(1.45, 850, 'AAIW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)
ax.text(1.45, 1350, 'NADW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)
ax.text(1.45, 1900, 'AABW', verticalalignment='center', horizontalalignment='right', color = 'k', fontsize=16)	

ax.set_title('h) Freshwater transport, HR-CESM (1994 - 2020)')
