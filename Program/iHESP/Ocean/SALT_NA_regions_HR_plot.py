...
fh = netcdf.Dataset(directory+'Ocean/SALT_NA_'+str(depth_min)+'_'+str(depth_max)+'m_trend_year_21-100_PI_control_HR.nc', 'r')
...
ax.set_title('c) Salinity NA regions, HR-CESM')
