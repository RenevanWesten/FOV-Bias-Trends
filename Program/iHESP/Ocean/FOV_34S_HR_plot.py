...
time_control1, FOV_gyre_control	 = ReadinDataGyre(directory+'Ocean/FOV_gyre_section_34S_PI_control_HR.nc')
time_rcp, FOV_rcp		         = ReadinData(directory+'Ocean/FOV_index_section_34S_RCP_HR.nc')
time_rcp, FOV_gyre_rcp		     = ReadinDataGyre(directory+'Ocean/FOV_gyre_section_34S_RCP_HR.nc')
time_control			         += 1599
#-----------------------------------------------------------------------------------------
