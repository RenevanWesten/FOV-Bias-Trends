...
fh = netcdf.Dataset(directory+'Ocean/SALT_SO_'+str(depth_min)+'_'+str(depth_max)+'m_trend_year_2000-2100_RCP_LR.nc', 'r')
...
ax.set_title('b) Salinity (0 - 100 m) trend, LR-CESM, Hist/RCP8.5 (2000 - 2100)')
