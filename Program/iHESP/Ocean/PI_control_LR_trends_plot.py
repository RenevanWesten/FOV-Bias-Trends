...
fh = netcdf.Dataset(directory+'Atmosphere/PREC_EVAP_SO_trend_year_'+str(year_start)+'-'+str(year_end)+'_PI_control_LR.nc', 'r')
...
ax.set_title('a) P-E trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')
...
fh = netcdf.Dataset(directory+'Ocean/SALT_SO_'+str(depth_min)+'_'+str(depth_max)+'m_trend_year_'+str(year_start)+'-'+str(year_end)+'_PI_control_LR.nc', 'r')
...
ax.coastlines('50m')
ax.add_feature(cfeature.LAND, zorder=0)
ax.set_title('b) Salinity (0 - 100 m) trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')

#-----------------------------------------------------------------------------------------

fh = netcdf.Dataset(directory+'Ocean/SST_NA_trend_year_'+str(year_start)+'-'+str(year_end)+'_PI_control_LR.nc', 'r')
...
ax.coastlines('50m')
ax.add_feature(cfeature.LAND, zorder=0)
ax.set_title('c) SST trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')

#-----------------------------------------------------------------------------------------

fh = netcdf.Dataset(directory+'Atmosphere/PREC_EVAP_NA_trend_year_'+str(year_start)+'-'+str(year_end)+'_PI_control_LR.nc', 'r')
...
ax.coastlines('50m')
ax.add_feature(cfeature.LAND, zorder=0)
ax.set_title('d) P-E trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')
...
fh = netcdf.Dataset(directory+'Ocean/SALT_NA_'+str(depth_min)+'_'+str(depth_max)+'m_trend_year_'+str(year_start)+'-'+str(year_end)+'_PI_control_LR.nc', 'r')
...
ax.coastlines('50m')
ax.add_feature(cfeature.LAND, zorder=0)
ax.set_title('e) Salinity (0 - 100 m) trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')
...
ax.coastlines('50m')
ax.add_feature(cfeature.LAND, zorder=0)
ax.set_title('f) Salinity (1000 - 3000 m) trend, LR-CESM, PI control ('+str(year_start)+'-'+str(year_end)+')')
#-----------------------------------------------------------------------------------------
